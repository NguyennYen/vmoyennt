    ...
    Public Function GetOtherListGroupBySystem(ByVal systemName As String) As List(Of OtherListGroupDTO)
        ...
        Else
            ...
            Select Case systemName.Trim()
                ...
                Case SystemCodes.Meal.ToString()
...
#Region "SendMail"
    ...
    Public Function SendMail() As Boolean
        ...
        Try
            ...
            Dim isExist = (From p In Context.SE_MAIL
                      Where p.ACTFLG = "P").Any
                    ...
                    Try
                        ...
                        For i = 0 To query.Count - 1
                            ...
                            Catch ex As Exception
                                WriteExceptionLog(ex, MethodBase.GetCurrentMethod.Name, "iCommon")
                                query(i).ACTFLG = "I"
                                If query(i).FAIL_COUNT Is Nothing Then
                                    query(i).FAIL_COUNT = 1
                                Else
                                    query(i).FAIL_COUNT = query(i).FAIL_COUNT + 1
                                End If

                                If query(i).FAIL_COUNT > 10 Then
                                    query(i).ACTFLG = "E"
                                End If
