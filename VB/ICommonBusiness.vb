...
#Region "Employee"
        <OperationContract()>
        Function GetEmployeeToPopupFind(_filter As EmployeePopupFindListDTO,
                                            ByVal PageIndex As Integer,
                                            ByVal PageSize As Integer,
                                            ByRef Total As Integer,
...
#Region "Student"
        <OperationContract()>
        Function GetStudentToPopupFind(ByVal _filter As StudentPopupFindListDTO,
                                            ByVal PageIndex As Integer,
                                            ByVal PageSize As Integer,
                                            ByRef Total As Integer,
        ...
        <OperationContract()>
        Function GetStudentToPopupFind_StudentID(ByVal _empId As List(Of Decimal)) As List(Of StudentPopupFindDTO)
#End Region
...
#Region "Kitchen"
        ...
        ''' <remarks></remarks>
        <OperationContract()>
        Function GetKitchen(ByVal Filter As AT_KITCHEN_DTO,
                            ByVal PageIndex As Integer,
                            ByVal PageSize As Integer,
                            ByRef Total As Integer,
                            Optional ByVal Sorts As String = "CREATED_DATE asc") As List(Of AT_KITCHEN_DTO)
        ''' <summary>
        ...
        ''' <remarks></remarks>
        <OperationContract()>
        Function GetKitchenFromId(ByVal _lstIds As List(Of Decimal)) As List(Of AT_KITCHEN_DTO)
#End Region
