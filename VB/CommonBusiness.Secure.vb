...
#Region "Student"
        ...
        Public Function GetStudentToPopupFind(ByVal _filter As StudentPopupFindListDTO,
                                            ...
                                            Optional ByVal log As UserLog = Nothing,
                                            Optional ByVal _param As ParamDTO = Nothing) As List(Of StudentPopupFindListDTO) _
                                        Implements ServiceContracts.ICommonBusiness.GetStudentToPopupFind
            Using rep As New CommonRepository
                Try
        ...
        Public Function GetStudentToPopupFind_StudentID(ByVal _empId As List(Of System.Decimal)) As List(Of CommonDAL.StudentPopupFindDTO) Implements ServiceContracts.ICommonBusiness.GetStudentToPopupFind_StudentID
            Using rep As New CommonRepository
                Try
...
#Region "Kitchen"
        ...
        Public Function GetKitchen(ByVal Filter As AT_KITCHEN_DTO,
                                ByVal PageIndex As Integer,
                                ByVal PageSize As Integer,
                                ByRef Total As Integer,
                                Optional ByVal Sorts As String = "CREATED_DATE asc") As List(Of AT_KITCHEN_DTO) Implements ServiceContracts.ICommonBusiness.GetKitchen
            Using rep As New CommonRepository
                Try

                    Dim lst = rep.GetKitchen(Filter, PageIndex, PageSize, Total, Sorts)
                    Return lst
                Catch ex As Exception
            ...
            End Using
        End Function
        Public Function GetKitchenFromId(ByVal _lstIds As List(Of Decimal)) As List(Of AT_KITCHEN_DTO) Implements ServiceContracts.ICommonBusiness.GetKitchenFromId
            Using rep As New CommonRepository
                Try
