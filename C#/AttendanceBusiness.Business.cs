...
namespace AttendanceBusiness.ServiceImplementations
{
    ...
    {
        public List<AT_DATAINOUTDTO> GetDataInout(AT_DATAINOUTDTO _filter, ParamDTO _param, ref int Total = 0, int PageIndex = 0, int PageSize = int.MaxValue, string Sorts = "EMPLOYEE_CODE, WORKINGDAY", UserLog log = null/* TODO Change to default(_) if this is not a reference type */)
        {
        ...
        public List<AT_COMPENSATORYDTO> GetNB(AT_COMPENSATORYDTO _filter, ParamDTO _param, ref int Total = 0, int PageIndex = 0, int PageSize = int.MaxValue, string Sorts = "CREATED_DATE desc", UserLog log = null/* TODO Change to default(_) if this is not a reference type */)
        {
            using (AttendanceRepository rep = new AttendanceRepository())
            {
                try
        ...
        public List<AT_ENTITLEMENTDTO> GetEntitlement(AT_ENTITLEMENTDTO _filter, ParamDTO _param, ref int Total = 0, int PageIndex = 0, int PageSize = int.MaxValue, string Sorts = "CREATED_DATE desc", UserLog log = null/* TODO Change to default(_) if this is not a reference type */)
        {
            using (AttendanceRepository rep = new AttendanceRepository())
            {
                try
        ...
        public bool CheckOffInMonth(ParamDTO _param, UserLog log = null/* TODO Change to default(_) if this is not a reference type */)
        {
            using (AttendanceRepository rep = new AttendanceRepository())
            {
                try
        ...
        public List<AT_LATE_COMBACKOUTDTO> GetLate_combackout(AT_LATE_COMBACKOUTDTO _filter, ParamDTO _param, ref int Total = 0, int PageIndex = 0, int PageSize = int.MaxValue, string Sorts = "CREATED_DATE desc", UserLog log = null/* TODO Change to default(_) if this is not a reference type */)
        {
            using (AttendanceRepository rep = new AttendanceRepository())
            {
                try
        ...
        public List<AT_REGISTER_OTDTO> GetRegisterOT(AT_REGISTER_OTDTO _filter, ParamDTO _param, ref int Total = 0, int PageIndex = 0, int PageSize = int.MaxValue, string Sorts = "CREATED_DATE desc", UserLog log = null/* TODO Change to default(_) if this is not a reference type */)
        {
            using (AttendanceRepository rep = new AttendanceRepository())
            {
                try
        ...
        public List<AT_TIME_TIMESHEET_MACHINETDTO> GetMachines(AT_TIME_TIMESHEET_MACHINETDTO _filter, ParamDTO _param, ref int Total = 0, int PageIndex = 0, int PageSize = int.MaxValue, string Sorts = "EMPLOYEE_ID, WORKINGDAY", UserLog log = null/* TODO Change to default(_) if this is not a reference type */)
        {
            using (AttendanceRepository rep = new AttendanceRepository())
            {
                try
        ...
        public List<AT_TIME_TIMESHEET_MONTHLYDTO> GetTimeSheet(AT_TIME_TIMESHEET_MONTHLYDTO _filter, ParamDTO _param, ref int Total = 0, int PageIndex = 0, int PageSize = int.MaxValue, string Sorts = "CREATED_DATE desc", UserLog log = null/* TODO Change to default(_) if this is not a reference type */)
        {
            using (AttendanceRepository rep = new AttendanceRepository())
            {
                try
        ...
        public List<AT_LEAVESHEETDTO> GetLeaveSheet(AT_LEAVESHEETDTO _filter, ParamDTO _param, ref int Total = 0, int PageIndex = 0, int PageSize = int.MaxValue, string Sorts = "CREATED_DATE desc", UserLog log = null/* TODO Change to default(_) if this is not a reference type */)
        {
            using (AttendanceRepository rep = new AttendanceRepository())
            {
                try
        ...
        public List<AT_TIME_RICEDTO> GetDelareRice(AT_TIME_RICEDTO _filter, ParamDTO _param, ref int Total = 0, int PageIndex = 0, int PageSize = int.MaxValue, string Sorts = "CREATED_DATE desc", UserLog log = null/* TODO Change to default(_) if this is not a reference type */)
        {
            using (AttendanceRepository rep = new AttendanceRepository())
            {
                try
        ...
        public List<AT_DECLARE_ENTITLEMENTDTO> GetDelareEntitlementNB(AT_DECLARE_ENTITLEMENTDTO _filter, ParamDTO _param, ref int Total = 0, int PageIndex = 0, int PageSize = int.MaxValue, string Sorts = "CREATED_DATE desc", UserLog log = null/* TODO Change to default(_) if this is not a reference type */)
        {
            using (AttendanceRepository rep = new AttendanceRepository())
            {
                try
        ...
        public List<AT_TIME_TIMESHEET_DAILYDTO> GetListExplanation(AT_TIME_TIMESHEET_DAILYDTO _filter, ParamDTO _param, ref int Total = 0, int PageIndex = 0, int PageSize = int.MaxValue, string Sorts = "EMPLOYEE_CODE desc,WORKINGDAY asc", UserLog log = null/* TODO Change to default(_) if this is not a reference type */)
        {
            using (AttendanceRepository rep = new AttendanceRepository())
            {
                try
